...
A token is used by the browser to prove its identity to a web server. It's issued by the web server to the browser when the user logs in and has to be added to the header of every subsequent request to access private resources.

- [ ] What steps can you take in your web apps to keep your data secure?

Use tokens to ensure that only authorised users have access to private information.

- [ ] Describe how web servers work.

Web servers receive requests for resources from other computers and determine how to respond based on the content of the request. If the request is valid the web server will reply with the requested resources. If not, it'll send an error message to alert the other computer that there's a problem.
